...
def main() -> None:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "To measure distance between items, prefer get_distance_between — it "
            "uses the scene's grid measurement mode (Chebyshev, hex, etc) for "
            "accurate results. For manual conversion: cells = pixels / dpi, "
            "feet = cells * scale.\n\n"
